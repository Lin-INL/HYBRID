...
model HITB_Experiment_01_Calibrate_sensitivity
...
//  Modelica.Units.SI.Power Q_loss;
  ...
  parameter Modelica.Units.SI.Temperature T_air = 273.15+250 "Air inside the shipping container estiPCMmate";
  ...
  PCM_Chamber_Connected PCM_Core(
    ...
    redeclare package PCM_Material = PCM_Materials.PCM_HITB_DensityFactor_alltuned)
...
end HITB_Experiment_01_Calibrate_sensitivity;
