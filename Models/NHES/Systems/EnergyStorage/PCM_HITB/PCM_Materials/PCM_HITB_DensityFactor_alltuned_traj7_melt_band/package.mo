...
package PCM_HITB_DensityFactor_alltuned_traj7_melt_band "PCM_HITB_using_sin_and_cos"
  ...
  constant Real melt_band(unit = "K") = 15.5;
                                        //melting band for phase change
  constant Modelica.Units.SI.Temperature T_melt = 733.15;
...
//  constant Real b1(unit = "J/(kg.K)") = 1500;
 ...
 // constant Real b3(unit = "J/(kg.K)") = 1588.57;
  ...
  constant Real k_mult_solid(unit = "W/m.K") = 140;
                                                //intercept for solid conductivity
  constant Real k_mult_liquid(unit = "W/m.K") = 83.775;
  ...
  constant Real density_mult = 0.35 annotation(Dialog(tab = "General"));
  //0.55
