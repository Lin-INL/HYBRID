...
package PCM_HITB_DensityFactor_alltuned_traj9_k_slope_mult "PCM_HITB_using_sin_and_cos"
  ...
  constant Real melt_band(unit = "K") = 6.5;
                                        //melting band for phase change
  constant Modelica.Units.SI.Temperature T_melt = 713.15;
...
//  constant Real b1(unit = "J/(kg.K)") = 1500;
 ...
 // constant Real b3(unit = "J/(kg.K)") = 1588.57;
  ...
  constant Real h_melt(unit = "J/kg") = 152500;
  ...
  //constant Real fT(unit = "1/K") = 2*Modelica.Constants.pi/(T_meltplus-T_meltmin);
                                                                                  //New constant
  constant Real k_slope_mult(unit = "W/m.K.K") = -0.0067;
