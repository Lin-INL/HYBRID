...
package PCM_HITB_DensityFactor_alltuned "PCM_HITB_using_sin_and_cos"
  ...
  constant Real melt_band(unit = "K") = 4.0;
                                        //melting band for phase change
  constant Modelica.Units.SI.Temperature T_melt = 723.15;
...
//  constant Real b1(unit = "J/(kg.K)") = 1500;
 ...
 // constant Real b3(unit = "J/(kg.K)") = 1588.57;
  ...
  constant Real h_melt(unit = "J/kg") = 160000.0;
  ...
  //constant Real fT(unit = "1/K") = 2*Modelica.Constants.pi/(T_meltplus-T_meltmin);
                                                                                  //New constant
  constant Real k_slope_mult(unit = "W/m.K.K") = -0.00536;
                                                //slope for conductivity
  constant Real k_mult_solid(unit = "W/m.K") = 112.0;
                                                //intercept for solid conductivity
  constant Real k_mult_liquid(unit = "W/m.K") = 111.7;
